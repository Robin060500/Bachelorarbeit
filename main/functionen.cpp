...
void start(string expo, string mant) {
	...
	*/
	...
	//write << "(assert (= z_sign (ite(bvuge x_expo y_expo) (ite(= x_expo y_expo) (ite(bvuge x_man y_man) (ite (not (= x_sign y_sign)) #b0 x_sign) y_sign ) x_sign ) y_sign )))" << endl;
	...
	write << "(declare-fun null_2 () (_ BitVec 1))" << endl;
	write << "(declare-fun a_p () (_ BitVec " << length - 7 << "))" << endl;
	write << "(declare-fun b_p () (_ BitVec " << length - 7 << "))" << endl;
	...
	write << "(declare-fun c_expo_finaaal () (_ BitVec " << expo_bit << " ))" << endl;
	...
	write << "(declare-fun c_mant_good3 () (_ BitVec " << mantis_bit + 4 << " ))" << endl;
	write << "(declare-fun mant_good2_2 () (_ BitVec " << mantis_bit + 4 << " ))" << endl;
	...
	write << "(declare-fun expo_diff_long_long_2 () (_ BitVec " << or_bit << " ))" << endl;
	write << "(declare-fun ori_2 () (_ BitVec 1))" << endl;
	write << "(declare-fun ori1_2 () (_ BitVec 1))" << endl;
	write << "(declare-fun ori2_2 () (_ BitVec 1))" << endl;
	write << "(declare-fun ori3_2 () (_ BitVec 1))" << endl;
	write << "(declare-fun ori4_2 () (_ BitVec 1))" << endl;
	write << "(declare-fun mant_long_2 () (_ BitVec " << or_bit << " ))" << endl;
	write << "(declare-fun mant_long2_2 () (_ BitVec " << or_bit << " ))" << endl;
	write << "(declare-fun mant_right_2 () (_ BitVec " << or_bit - mantis_bit - 4 << " ))" << endl;
	...
	write << "(declare-fun over9_2 () (_ BitVec 1))" << endl;
	write << "(declare-fun over10_2 () (_ BitVec 1))" << endl;
	...
	write << endl;
	/*
	write << "(assert (= a (concat null a_p)))" << endl;
	write << "(assert (= b (concat null b_p)))" << endl;
	write << "(assert (= null_2 #b0))" << endl;
	*/
	//add the 6 zeros
	write << ";;;add the 6 zeros" << endl;
	...
	//new part
	write << "(assert (= mant_long_2(ite (bvuge a_expo b_expo) (ite (= a_expo b_expo) (ite (bvuge a_man b_man) (concat b_mant (_ bv0 " << or_bit - mantis_bit - 7 << "))";
	write << "(concat a_mant(_ bv0 " << or_bit - mantis_bit - 7 << ")))(concat b_mant(_ bv0 " << or_bit - mantis_bit - 7 << ")))(concat a_mant(_ bv0 " << or_bit - mantis_bit - 7 << ")))))" << endl;
	write << "(assert (= expo_diff_long_long_2 (concat (_ bv0 " << or_bit - mantis_bit - 7 << ") expo_diff_long_2)))" << endl;
	write << "(assert (= mant_long2_2 (bvlshr mant_long_2 expo_diff_long_long_2)))" << endl;
	write << "(assert (= mant_right_2 ((_ extract " << or_bit - mantis_bit - 5 << " 0) mant_long2_2)))" << endl;
	write << "(assert (= ori2_2 (ite (bvuge mant_right_2 (_ bv1 " << or_bit - mantis_bit - 4 << ")) #b1 #b0)))" << endl;
	write << "(assert (= ori3_2 ((_ extract 0 0)mant_short_2)))" << endl;
	write << "(assert (= mant_good2_2 (ite (and (= ori2_2 #b1)(= ori3_2 #b0)) (bvadd mant_short_2 (_ bv1 " << mantis_bit + 4 << ")) mant_short_2)))" << endl;
	...
	write << " other_man_2)) (= mant_short_2 ((_ extract " << mantis_bit + 6 << " 3) mant_2))))" << endl;
	...
	write << "(assert (= overflow1_2 (ite (or (and (= den_2 #b0) (xor (= denormala #b0) (= denormalb #b0)))(and (or (or (and (= over1_2 #b1) (= over2_2 #b1)) (and (= over4_2 #b1) (= over5_2 #b1))) (and (xor (= over1_2 #b1) (= over2_2 #b1)) (= over3_2 #b0))) (= a_sign b_sign))) #b1 #b0 )))" << endl;
	write << "(assert (= c_mant_over (ite (and (= overflow1_2 #b1) (or (= denormala #b0) (= denormalb #b0)))(bvlshr c_mant (_ bv1 " << mantis_bit + 4 << ")) c_mant )))" << endl;
	string n3_str_2 = "#b1";
	for (int n = 0; n < mantis_bit + 3; n++) {
		n3_str_2 = n3_str_2 + "0";
	}
	write << "(assert (= c_mant_good (ite (and (= overflow1_2 #b1) (or (= denormala #b0) (= denormalb #b0)))(bvadd c_mant_over " << n3_str_2 << ") c_mant_over )))" << endl;
	write << "(assert (= c_expo_final (ite (and (= overflow1_2 #b1) (or (= denormala #b0) (= denormalb #b0)))(bvadd c_expo2 (_ bv1 " << expo_bit << ")) c_expo2 )))" << endl;
	write << "(assert (= ori_2 ((_ extract 0 0) c_mant)))" << endl;
	write << "(assert (= ori4_2 ((_ extract 0 0) c_mant_good)))" << endl;
	write << "(assert (= c_mant_good3 (ite (and (or (= ori2_2 #b1) (= ori3_2 #b1)) (= ori4_2 #b0)) (bvadd c_mant_good (_ bv1 " << mantis_bit + 4 << ")) c_mant_good)))" << endl;
	...
	write << "(assert (= overflow2_2 (ite (or (= c_expo_final " << n9_str << ")(and (= over7_2 #b1) (= over8_2 #b0))) #b1 #b0 )))" << endl;

	write << endl;
	//mant/ expo underflow (schleife ausgeschrieben)
	write << ";;;mant/ expo underflow (schleife ausgeschrieben" << endl;
	write << "(assert (= m1_2 ((_ extract " << mantis_bit + 3 << " " << mantis_bit + 3 << ") c_mant_good3)))" << endl;
	write << "(assert (= c_mant_2_2(ite (and (= m1_2 #b0) (and (= denormala #b0) (= denormalb #b0)))(bvshl c_mant_good3 (_ bv1 " << mantis_bit + 4 << ")) c_mant_good3 )))" << endl;
	...
	//decide the sign
	write << ";;;decide the sign" << endl;
	//write << "(assert (= c_sign (ite(bvuge a_expo b_expo) (ite(= a_expo b_expo) (ite(bvuge a_man b_man) (ite (not (= a_sign b_sign)) #b0 a_sign) b_sign ) a_sign ) b_sign )))" << endl;
	...
	// check over again
	write << "(assert (= over9_2 ((_ extract " << mantis_bit + 3 << " " << mantis_bit + 3 << ") c_mant_" << mantis_bit + 3 << "_2)))" << endl;
	write << "(assert (= over10_2 ((_ extract " << mantis_bit + 3 << " " << mantis_bit + 3 << ") c_mant_good2)))" << endl;
	write << "(assert (= c_expo_finaaal (ite (and (= over9_2 #b1) (= over10_2 #b0)) (bvadd c_expo_" << mantis_bit + 3 << "_2 (_ bv1 " << expo_bit << ")) c_expo_" << mantis_bit + 3 << "_2)))" << endl;



	write << "(assert (= c_short(ite (= nan_2 #b0) (ite (= inf_2 #b0) (ite (= overflow2_2 #b0) (ite (= underflow1_2 #b0)";
	write << "(concat c_expo_finaaal c_mant_final)(_ bv0 " << length - 7 << ")) " << n5_str_2 << " ) " << n5_str_2 << " ) " << n6_str_2 << " )))" << endl;
